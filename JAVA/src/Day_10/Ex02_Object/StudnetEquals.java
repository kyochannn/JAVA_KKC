...
public class StudnetEquals {
	...
	public static void main(String[] args) {
		...
		if(student.equals(student2))
			...
			System.out.println("sutdent와 student2는 다른 학생입니다.");
		...
		if(student.equals(student3))
			System.out.println("student와 student3는 같은 학생입니다.");
		else 
			System.out.println("sutdent와 student3는 다른 학생입니다.");
	}
}
